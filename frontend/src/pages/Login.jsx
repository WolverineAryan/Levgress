...
import { Trophy, Flame, BarChart3, GraduationCap, Mail, Lock, Loader2 } from 'lucide-react';
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative z-10 bg-bg-secondary/10">
        ...
        <div className="w-full max-w-[420px] flex flex-col space-y-7 bg-bg-card p-10 rounded-[32px] border border-border-subtle shadow-2xl relative z-10">
          <div>
            ...
            <h2 className="text-xl font-extrabold text-text-primary text-center">Sign In</h2>
            <p className="text-xs text-text-secondary text-center mt-1">Access the Student or Instructor dashboard using single sign-on.</p>
          </div>
