...
const AllIcons = [
  CpuIcon, DatabaseIcon, CodeIcon, ServerIcon, NetworkIcon, TerminalIcon, ShieldIcon, CloudIcon, GearIcon
];
...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-[#FFF8F0] overflow-hidden py-8">
      ...
      {/* Modern Animated Background - Unchanged */}
      ...
      {/* Modern Login Card - Reduced padding */}
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-[#C08552]/30 bg-white/50 px-3 py-2 text-sm text-[#4B2E2B] placeholder:text-[#8C5A3C]/50 outline-none transition-all focus:border-[#C08552] focus:ring-2 focus:ring-[#C08552]/20 focus:bg-white"
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label className="block text-xs font-semibold text-[#4B2E2B]">
                Password
              </label>
              <a
                href="#"
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-lg border border-[#C08552]/30 bg-white/50 px-3 py-2 text-sm text-[#4B2E2B] placeholder:text-[#8C5A3C]/50 outline-none transition-all focus:border-[#C08552] focus:ring-2 focus:ring-[#C08552]/20 focus:bg-white pr-9"
                placeholder="Enter your password"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-2 top-1/2 -translate-y-1/2 w-4 h-4 text-[#8C5A3C] hover:text-[#C08552] transition-colors"
              >
          ...
          <button
            type="submit"
            disabled={loading}
            className="relative w-full py-2 rounded-lg bg-gradient-to-r from-[#C08552] to-[#8C5A3C] hover:from-[#8C5A3C] hover:to-[#4B2E2B] text-white font-semibold text-sm transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-60 disabled:hover:scale-100 shadow-md overflow-hidden group mt-1.5"
          >
